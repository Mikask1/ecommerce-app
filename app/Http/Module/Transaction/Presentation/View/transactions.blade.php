                        ...
                        @foreach ($transaction->details as $detail)
                            <div class="product-card d-flex align-items-center">
                                <div class="product-img">
                                    <img src="{{ asset('storage/' . $detail->product->gambar) }}" width="60"
                                ...
                                <div class="product-actions">
                                    <button type="button" class="reviewButton" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal{{ $detail->id }}">Buat ulasan</button>
                                </div>

                                <form action="{{ url('update_review') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')<div class="modal fade" id="exampleModal{{ $detail->id }}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <input type="hidden" name="transaction_detail_id"
                                                            value="{{ $detail->id }}">

                                                        <div class="p-2">
                                                            <label class="pb-2" for="ratingInput">Rating:</label>
                                                            <input class="form-control pt-2" type="number"
                                                                name="rating" id="ratingInput" placeholder="0"
                                                                max='5' min="1">
                                                        </div>

                                                        <div class="p-2">
                                                            <label class="pb-2" for="reviewInput">Review:</label>
                                                            <textarea class="form-control pt-2" type="text" name="review" id="reviewInput" rows="3"
