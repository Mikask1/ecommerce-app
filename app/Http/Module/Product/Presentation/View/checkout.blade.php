                ...
                <form action="/create_transaction" method="POST" enctype="multipart/form-data">
                    ...
                    @foreach ($checkoutData as $index => $data)
                        <div class="row receipt justify-content-between align-items-center">
                            ...
                            <div class="col-3 d-flex justify-content-center" style="gap: 8px;">
                                <p>
                        ...
                        <input type="hidden" name="product[{{ $index }}][quantity]"
                            value="{{ $data['quantity'] }}">
                    @endforeach
                    ...
                    <div class="bayar" style='margin-top:16px'>
                        <button type="submit" class="btn btn-dark" style="margin-top:16px">Lakukan pembayaran</button>
                    </div>
                </form>
            </div>
        </div>
