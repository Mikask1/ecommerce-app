        ...
        <div class="card text-center col-lg-5 col-md-7" style="padding: 0; border: 0; border-radius: 0;">
          <div class="card-header cardHeader" style="border-radius: 0; background-color: #9a4444;">
            <ul class="nav nav-tabs card-header-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link signup-show active" style="border: 1px solid white; border-radius: 0;" href="#">Sign Up</a>
              </li>
            </ul>
          </div>
          <div class="card-body">
              ...
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-floating mb-3">
                    <div class="mt-4" style="width: 100%;">
                        <x-input-label style="width: 40%" for="name" :value="__('Name')" />
                        <x-text-input style="width: 50%" id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                ...
                <div class="form-floating mb-3">
                    <div class="mt-4" style="width: 100%;">
                        ...
                        <x-text-input style="width: 50%" id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>
                </div>
                <div class="form-floating mb-3">
                    <div class="mt-4" style="width: 100%;">
                        <x-input-label style="width: 40%" for="phone_number" :value="__('Phone Number')" />
                        <x-text-input style="width: 50%" id="phone_number" class="block mt-1 w-full" type="text" name="phone_number" :value="old('phone_number')" required autocomplete="tel" />
                ...
                <div class="form-floating mb-3">
                    <div class="mt-4" style="width: 100%;">
                        <x-input-label style="width: 40%" for="password_confirmation" :value="__('Confirm Password')" />

                        <x-text-input style="width: 50%" id="password_confirmation" class="block mt-1 w-full"
                                        type="password"
                ...
                <div class="flex items-center justify-end mt-4">
                    <x-primary-button class="ml-4" style="background-color: #9a4444; margin-top:20px; width: 100%;">
                        {{ __('Register') }}
                    </x-primary-button>
                </div>
              </form>
