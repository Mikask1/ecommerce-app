...
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
    <a class="navbar-brand" href="{{ route('products') }}">
        <img src="https://cdn.discordapp.com/attachments/1163489620005224503/1170615904049037362/pikasa-high-resolution-logo-white-transparent.png?ex=6559b004&is=65473b04&hm=d22ba723837e1331d545e53f47800787ef55897922c0de047dc2033030414d09&"
        ...
        <a class="nav-link" href="{{ route('products') }}">Home <span class="sr-only">(current)</span></a>
            ...
            <li class="nav-item nav-link ml-auto">
                <x-dropdown align="center" width="100">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center align- focus:outline-none transition ease-in-out duration-150">
                            <div>Admin</div>
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('admin.product')" style="color:#3c0f83" class="nav-item-custom">
                            {{ __('Product') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('admin.transactions')" style="color:#3c0f83" class="nav-item-custom">
                            {{ __('Transaction') }}
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
            ...
            <li class="nav-item nav-link ml-auto">
                <x-dropdown align="center" width="100">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" style="color:#3c0f83" class="nav-item-custom">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" style="color:#3c0f83" class="nav-item-custom"
